# Research HTTP Service

## Purpose

Define the validated HTTP boundary, provider-free operational endpoints, stable
sanitized failures, and graceful lifecycle behavior for the research agent.
