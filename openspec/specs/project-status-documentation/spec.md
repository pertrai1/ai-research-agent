...
Define accurate, secret-safe project status and operational guidance after a
roadmap phase is completed.
...
follow-up. It SHALL NOT contain stale claims that the package manifest is a stub
or that Phase 1 commands are pending.
